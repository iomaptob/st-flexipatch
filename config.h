...
#if SCROLLBACK_MOUSE_PATCH || SCROLLBACK_MOUSE_ALTSCREEN_PATCH || REFLOW_PATCH //~
const unsigned int scrollIncrement = 4; //~
#endif //~
...
static MouseShortcut mshortcuts[] = {
	...
	{ ShiftMask,            Button4, kscrollup,      {.i = scrollIncrement},      0, S_PRI}, //~
	{ ShiftMask,            Button5, kscrolldown,    {.i = scrollIncrement},      0, S_PRI}, //~
	...
	{ XK_ANY_MOD,           Button4, kscrollup,      {.i = scrollIncrement},      0, S_PRI }, //~
	{ XK_ANY_MOD,           Button5, kscrolldown,    {.i = scrollIncrement},      0, S_PRI }, //~
